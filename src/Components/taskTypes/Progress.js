...
const Progress = ({inprogressCount,tasks,filterState,search,startDateFilter,endDateFilter,assigneeFilter,handleDragStart}) =>{
    return(
        <div>
<h2 className='font-bold border-sky-500 border-b-2 pb-[10%] mb-[10%]'>In Progress({inprogressCount.length})</h2>
